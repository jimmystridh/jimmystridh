...
[![LinkedIn](https://img.shields.io/badge/jimmys-0A66C2?style=flat&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/jimmys/)
...
| [claude-agents-sdk](https://github.com/jimmystridh/claude-agents-sdk) | Rust SDK for building agents with Claude Code CLI | ![Rust](https://img.shields.io/badge/-Rust-CE422B?style=flat-square&logo=rust&logoColor=white) |
| [claude-agent-sdk-csharp](https://github.com/jimmystridh/claude-agent-sdk-csharp) | C# SDK for building agents with Claude Code CLI | ![C#](https://img.shields.io/badge/-C%23-512BD4?style=flat-square&logo=csharp&logoColor=white) [![NuGet Version](https://img.shields.io/nuget/v/ih0.Claude.Agent.SDK?style=flat-square)](https://www.nuget.org/packages/ih0.Claude.Agent.SDK) |
| [google-docs-skill](https://github.com/jimmystridh/google-docs-skill) | Claude Code skill for Google Docs, Sheets & Drive — native Rust binaries | ![Rust](https://img.shields.io/badge/-Rust-CE422B?style=flat-square&logo=rust&logoColor=white) |
| [claude-dialog](https://github.com/jimmystridh/claude-dialog) | Native macOS SwiftUI dialog for Claude Code's AskUserQuestion tool | ![Swift](https://img.shields.io/badge/-Swift-F05138?style=flat-square&logo=swift&logoColor=white) |
| [gemini-dewatermark](https://github.com/jimmystridh/gemini-dewatermark) | CLI tool to remove watermarks from Gemini-generated images using LaMa inpainting | ![Rust](https://img.shields.io/badge/-Rust-CE422B?style=flat-square&logo=rust&logoColor=white) |
| [mindscape](https://github.com/jimmystridh/mindscape) | A visual map of what's going on in your head right now | ![HTML](https://img.shields.io/badge/-HTML-E34F26?style=flat-square&logo=html5&logoColor=white) |
| [geekmagic-stats](https://github.com/jimmystridh/geekmagic-stats) | Push Claude Code usage stats to a GeekMagic SmallTV display | ![Rust](https://img.shields.io/badge/-Rust-CE422B?style=flat-square&logo=rust&logoColor=white) |
| [cookie-scoop](https://github.com/jimmystridh/cookie-scoop) | Cross-platform browser cookie extraction for Rust | ![Rust](https://img.shields.io/badge/-Rust-CE422B?style=flat-square&logo=rust&logoColor=white) |
| [toon-rs](https://github.com/jimmystridh/toon-rs) | Token-efficient serialization format for LLMs | ![Rust](https://img.shields.io/badge/-Rust-CE422B?style=flat-square&logo=rust&logoColor=white) [![crates.io](https://img.shields.io/crates/v/toon-rs.svg?style=flat-square)](https://crates.io/crates/toon-rs) |
...
| [prowl](https://github.com/jimmystridh/prowl) | Fast CLI for Prowl push notifications | ![Rust](https://img.shields.io/badge/-Rust-CE422B?style=flat-square&logo=rust&logoColor=white) |
| [treenav](https://github.com/jimmystridh/treenav) | Terminal directory navigator with fuzzy search, bookmarks, vim-style keybindings | ![Rust](https://img.shields.io/badge/-Rust-CE422B?style=flat-square&logo=rust&logoColor=white) |
...
| [gorilla.rs](https://github.com/jimmystridh/gorilla.rs) | Rust port of the classic QBasic Gorillas game from 1991 | ![Rust](https://img.shields.io/badge/-Rust-CE422B?style=flat-square&logo=rust&logoColor=white) |
| [spawngate](https://github.com/jimmystridh/spawngate) | Serverless-style reverse proxy that spawns backends on demand | ![Rust](https://img.shields.io/badge/-Rust-CE422B?style=flat-square&logo=rust&logoColor=white) |
...
| [smtp-sink](https://github.com/jimmystridh/smtp-sink) | Minimal SMTP sink for local development and testing | ![Rust](https://img.shields.io/badge/-Rust-CE422B?style=flat-square&logo=rust&logoColor=white) |
| [spiris-rust](https://github.com/jimmystridh/spiris-rust) | Rust client for Visma eAccounting API | ![Rust](https://img.shields.io/badge/-Rust-CE422B?style=flat-square&logo=rust&logoColor=white) |
| [spiris-client](https://github.com/jimmystridh/spiris-client) | TypeScript client for Visma eAccounting API | ![TS](https://img.shields.io/badge/-TS-3178C6?style=flat-square&logo=typescript&logoColor=white) |
| [vscode-close-all-non-terminal-tabs](https://github.com/jimmystridh/vscode-close-all-non-terminal-tabs) | VS Code extension to close all tabs except terminal editors | ![TS](https://img.shields.io/badge/-TS-3178C6?style=flat-square&logo=typescript&logoColor=white) |
...
| [alfred-loopback-control](https://github.com/jimmystridh/alfred-loopback-control) | Alfred workflow + CLI for Rogue Amoeba's Loopback | ![Shell](https://img.shields.io/badge/-Shell-4EAA25?style=flat-square&logo=gnubash&logoColor=white) |
